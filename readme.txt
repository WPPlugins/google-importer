...
= 1.1.2 =
* Temporary fix for a bug with selective tags near line breaks until a better fix can be found

= 1.1.1 =
* Fixed time zone bug that could cause scheduled and duplicate posts
